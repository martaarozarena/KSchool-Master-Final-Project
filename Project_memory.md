...
* [YouGov Covid 19 Behaviour Tracker](https://yougov.co.uk/topics/international/articles-reports/2020/03/17/personal-measures-taken-avoid-covid-19): percentage of people who say they are wearing a face mask when in public places in each country. This data can be downloaded already in time series format, and is added to the `exogenous` dataset, at country level.
...
* [Eurocontrol airport traffic dataset](https://ansperformance.eu/data/): the number of daily arrivals by country (only for European countries) is included in the `exogenous` dataset.
